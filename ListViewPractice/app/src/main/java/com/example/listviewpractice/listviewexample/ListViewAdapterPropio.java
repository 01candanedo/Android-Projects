package com.example.listviewpractice.listviewexample;
...
public class ListViewAdapterPropio extends ArrayAdapter<Titulos> {
    ...
    public ListViewAdapterPropio(Context context, List<Titulos> datos){
        super(context, R.layout.listview_foods, datos);
        opciones = datos;
    }

    public View getView(int position, View convertView, ViewGroup parent) {
        LayoutInflater inflater = LayoutInflater.from(getContext());
        View item = inflater.inflate(R.layout.listview_foods, null);
